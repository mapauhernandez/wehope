...
class DoWLandingPage extends StatefulWidget {
  @override
  State<DoWLandingPage> createState() => _DoWLandingPageState();
}

class _DoWLandingPageState extends State<DoWLandingPage> {
  int currentIndex = 0;
  bool cur_body = true;
  ...
  return Scaffold(
      appBar: cur_body ? DoWLandingAppBar() : scaffolds[currentIndex],
      body: cur_body ? DowLandingBody() : screens[currentIndex],
