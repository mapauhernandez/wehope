...
class MedLandingPage extends StatefulWidget {
  @override
  State<MedLandingPage> createState() => _MedLandingPageState();
}

class _MedLandingPageState extends State<MedLandingPage> {
  int currentIndex = 0;
  bool cur_body = true;
  ...
  return Scaffold(
      appBar: cur_body ? MedLandingAppBar() : scaffolds[currentIndex],
      body: cur_body ? MedLandingBody() : screens[currentIndex],
