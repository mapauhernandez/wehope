...
class BeautyLandingPage extends StatefulWidget {
  @override
  State<BeautyLandingPage> createState() => _BeautyLandingPageState();
}

class _BeautyLandingPageState extends State<BeautyLandingPage> {
  int currentIndex = 0;
  bool cur_body = true;
