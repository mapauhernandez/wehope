...
class EduLandingPage extends StatefulWidget {
  @override
  State<EduLandingPage> createState() => _EduLandingPageState();
}

class _EduLandingPageState extends State<EduLandingPage> {
  int currentIndex = 0;
  bool cur_body = true;
