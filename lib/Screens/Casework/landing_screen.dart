...
class CWLandingPage extends StatefulWidget {
  @override
  State<CWLandingPage> createState() => _CWLandingPageState();
}

class _CWLandingPageState extends State<CWLandingPage> {
  int currentIndex = 0;
  bool cur_body = true;
  ...
  return Scaffold(
      appBar: cur_body ? CWLandingAppBar() : scaffolds[currentIndex],
      body: cur_body ? CWLandingBody() : screens[currentIndex],
